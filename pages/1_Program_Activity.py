...
st.set_page_config(
    page_title="Spire: Program Activity",
    page_icon=image,
    layout="wide",
)
st.write(
...
if st.button("Load data"):
    if utils.RUN_INTERACTIVE_QUERIES:
        ...
        chart = (
            ...
            .encode(
                ...
                y=alt.Y(
                    "New Wallets", scale=alt.Scale(domain=[0, program_usage_data["Active Wallets"].max()])
                ),
                tooltip=[
        ...
        st.write("Currently not running interactive queries. Please check back later.")
